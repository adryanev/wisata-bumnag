...
@section('page-header')
Souvenir <small><i class="c-white-500 ti-brush"></i></small>
...
<div class="col-sm-8 bgc-white mT-20">
    <h5 class="p-15">Souvenir {{ $souvenir->name }} Photos</h5>
    <hr>
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img class="img-fluid" src="{{ $medias->original_url }}" alt="Souvenir {{ $souvenir->name }} image" height="500px" width="250px">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modal{{ $number }}Label">Media {{ $souvenir->name }} </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <img class="img-responsive" src="{{ $medias->original_url }}" alt="Media {{ $souvenir->name }}">
                                            </div>
